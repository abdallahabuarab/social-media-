...
<div class="col-lg-6">
                ...
                <ul class="we-comet">
                    <li>
                        ...
                        <ul>
                            <li>
                                <div class="comet-avatar">
                                    <img src="{{asset('frontend/assets/images/resources/comet-2.jpg')}}" alt="">
                                </div>
                                <div class="we-comment">
                                    <div class="coment-head">
                            ...
                            <li>
                                <div class="comet-avatar">
                                    <img src="{{asset('frontend/assets/images/resources/comet-3.jpg')}}" alt="">
                                </div>
                                <div class="we-comment">
                                    <div class="coment-head">
    ...
    <div class="central-meta item">
        <div class="user-post">
            <div class="friend-info">
                <figure>
                    <img src="{{asset('frontend/assets/images/resources/nearly1.jpg')}}" alt="">
                </figure>
                <div class="friend-name">
    ...
    <div class="central-meta item">
        <div class="user-post">
            <div class="friend-info">
                <figure>
                    <img src="{{asset('frontend/assets/images/resources/nearly6.jpg')}}" alt="">
                </figure>
                <div class="friend-name">
    ...
    <div class="central-meta item">
        <div class="user-post">
            <div class="friend-info">
                <figure>
                    <img alt="" src="{{asset('frontend/assets/images/resources/friend-avatar10.jpg')}}">
                </figure>
                <div class="friend-name">
                    <ins><a title="" href="time-line.html">Ahmad Zytoon</a></ins>
                    <span>published: june,2 2018 19:PM</span>
                </div>
                <div class="description">
                ...
                <div class="post-meta">
                    <div class="linked-image align-left">
                        <a title="" href="#"><img alt="" src="{{asset('frontend/assets/images/resources/page1.jpg')}}"></a>
                    </div>
                    <div class="detail">
